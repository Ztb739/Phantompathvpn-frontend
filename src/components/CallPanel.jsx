      ...
      <div className="flex flex-col w-full md:w-[340px] lg:w-[400px] bg-[#111b21] border-r border-[#222d35] flex-shrink-0">
        ...
        <div className="px-4 py-4 bg-[#0b141a] border-b border-[#222d35]">
          <div className="bg-[#202c33] rounded-xl p-3 mb-3 flex items-center">
            <input value={dialNumber} onChange={(e) => handleDialInput(e.target.value)} placeholder="Name or number..." autoComplete="one-time-code" autoCorrect="off" autoCapitalize="off" spellCheck="false" data-form-type="other" data-lpignore="true" inputMode="text" className="flex-1 bg-transparent text-[#e9edef] text-lg text-center outline-none placeholder:text-[#8696a0]" style={mono} />
