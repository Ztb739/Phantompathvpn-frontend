        ...
        duration: 0.6
          ...
          <div className="flex flex-col items-center text-center gap-5 mb-10 w-full max-w-[90vw] mx-auto hero-text-area">
            ...
            <a
              ...
              className="mt-5 inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-[#00ffc8]/30 bg-[#00ffc8]/10 text-[#00ffc8] text-[10px] sm:text-sm font-bold uppercase tracking-wide text-center leading-tight hover:bg-[#00ffc8]/20 hover:border-[#00ffc8]/50 hover:shadow-[0_0_30px_rgba(0,255,200,0.15)] transition-all duration-300"
            >
