        ...
        <>
          ...
          <div className="flex items-center gap-2 px-3 py-2.5 bg-[#202c33]">
            <div className="flex-1 relative">
              <input ref={inputRef} value={newMessage} onChange={(e) => setNewMessage(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); sendMsg(); } }} placeholder="Type a message" autoComplete="one-time-code" autoCorrect="off" autoCapitalize="off" spellCheck="false" data-form-type="other" data-lpignore="true" inputMode="text" className="w-full h-10 bg-[#2a3942] text-[#e9edef] text-sm placeholder:text-[#8696a0] rounded-lg px-4 border-none outline-none focus:ring-0" maxLength={1600} />
            </div>
