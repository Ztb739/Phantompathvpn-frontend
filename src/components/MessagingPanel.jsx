        ...
        <>
                    ...
                    <React.Fragment key={m.id}>
                      ...
                      <div className={cn("flex mb-0.5", isOut ? "justify-end" : "justify-start")}>
                        <div className={cn(
                          ...
                          <p className="text-[#e9edef] text-[14.2px] leading-[19px] pr-14 break-words">{m.body}</p>
          ...
          {showTopUp && (
            <div className="px-3 py-2.5 bg-[#182229] border-t border-[#222d35]">
              <div className="bg-[#1a2517] border border-[#f59e0b]/20 rounded-xl p-4 text-center shadow-[0_0_20px_rgba(245,158,11,0.05)]">
                ...
                <div className="flex gap-2 justify-center mb-2">
                  <button onClick={() => { toast({ title: 'Private Beta', description: 'Top-ups coming soon.' }); setShowTopUp(false); }} className="h-8 px-4 bg-[#f59e0b]/20 border border-[#f59e0b]/40 text-[#f59e0b] text-xs font-bold rounded-lg hover:bg-[#f59e0b]/30 hover:shadow-[0_0_15px_rgba(245,158,11,0.2)] active:scale-95 transition-all">£1 — 20 msgs</button>
                  <button onClick={() => { toast({ title: 'Private Beta', description: 'Top-ups coming soon.' }); setShowTopUp(false); }} className="h-8 px-4 bg-[#f59e0b]/20 border border-[#f59e0b]/40 text-[#f59e0b] text-xs font-bold rounded-lg hover:bg-[#f59e0b]/30 hover:shadow-[0_0_15px_rgba(245,158,11,0.2)] active:scale-95 transition-all">£3 — 60 msgs</button>
