    ...
    <div className={cn("flex flex-col bg-[#111b21] border-r border-[#222d35] h-full", activeContact ? "hidden md:flex md:w-[340px] lg:w-[400px] flex-shrink-0" : "w-full md:w-[340px] lg:w-[400px] flex-shrink-0")}>
      ...
      <div className="px-3 py-2 bg-[#111b21]">
        <div className="relative">
          ...
          <input value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search or start new chat" autoComplete="off" className="w-full h-9 bg-[#202c33] text-[#e9edef] text-sm placeholder:text-[#8696a0] rounded-lg pl-10 pr-4 border-none outline-none focus:ring-0" />
        </div>
      </div>
